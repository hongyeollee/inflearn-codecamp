...
const boardsService_1 = require("./boardsService");
const boardEntity_1 = require("./entities/boardEntity");
...
let BoardsResolver = class BoardsResolver {
    ...
    creatBoard(createBoardInput) {
        return this.boardsService.create({ createBoardInput });
    }
};
__decorate([
    (0, graphql_1.Query)(() => [boardEntity_1.Board], { nullable: true }),
...
], BoardsResolver.prototype, "creatBoard", null);
BoardsResolver = __decorate([
    (0, graphql_1.Resolver)(),
    __metadata("design:paramtypes", [boardsService_1.BoardsService])
], BoardsResolver);
exports.BoardsResolver = BoardsResolver;
//# sourceMappingURL=boardsResolver.js.map